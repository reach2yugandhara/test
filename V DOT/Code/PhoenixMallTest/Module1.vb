...
Module Module1
    ...
    Sub Main()
        ...
        Try
            ...
            Dim querystr As String = "select RECEIPTID,CREATEDDATETIME,PAYMENTAMOUNT,DISCAMOUNT from ax.RETAILTRANSACTIONTABLE where CREATEDDATETIME>'" + salres + "' and RECEIPTID like '2221901%' order by CREATEDDATETIME"
            ...
            While dr.Read()
                ...
                Dim query_1 As String = "select ITEMID,TAXAMOUNT,QTY,DISCAMOUNT,PRICE,NETAMOUNTINCLTAX*-1 from ax.RETAILTRANSACTIONSALESTRANS where RECEIPTID like '2221901%'  and CREATEDDATETIME>'" + salres + "' and TRANSACTIONSTATUS=0 and RECEIPTID='" + receiptNo + "'"
