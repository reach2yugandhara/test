...
Module Module1
    ...
    Sub Main()
        ...
        Try
            ...
            cn.Open()
            Dim querystr As String = "SELECT s.DocNoPrefix,s.DocNo,s.DocDt,s.TotDocValue,s.TotDocTax,s.NetDocValue,s.TotDocDisc,s.TotalLineItems,s.TrnType,s.TrnCtrlNo, s.DocVoidInd,s.FrwdRefCtrlNo,FrwdRefTrnType FROM StkTrnHdr s where s.TrnCtrlNo > " + saleLastNo.ToString() + " and DocNoPrefix like '971S%' order by s.TrnCtrlNo"
        ...
        Try
            ...
            cn = New OleDbConnection(connectString)
            cn.Open()
            Dim querystr As String = "SELECT s.DocNoPrefix,s.DocNo,s.DocDt,s.TotDocValue,s.TotDocTax,s.NetDocValue,s.TotDocDisc,s.TotalLineItems,s.TrnType,s.TrnCtrlNo, s.DocVoidInd,s.FrwdRefCtrlNo,FrwdRefTrnType FROM StkTrnHdr s where s.TrnCtrlNo > " + returnLastNo.ToString() + " and DocNoPrefix like '971R%' or DocNoPrefix like '971VS%' or DocNoPrefix like '971SSR%'"
