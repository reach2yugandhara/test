...
Module Module1
    ...
    Sub Main()
        ...
        Try
            ...
            Dim querystr As String = "select DocNoPrefix,DocNo,DocTime,TotDocValue as gross_amt,NetDocValue as total_amount,TotDocTax ,TotDocDisc,TotalLineItems,TrnType as flag   from StkTrnHdr where DocTime > '" + response + "' order by DocTime "
