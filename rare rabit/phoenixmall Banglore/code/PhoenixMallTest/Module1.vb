...
Module Module1
    ...
    Sub Main()
        ...
        'Dim sale_date As String = response1                 ashish
        ...
        Try
            ...
            While dr.Read()
                ...
                Dim query_1 As String = "select a.ItemId,(select b.Name from dbo.Item b where a.ItemId=b.ItemId), Qty,TaxAmt,DiscountAmt,NetAmt,MRP,taxableamt  from dbo.POSBillItem a where a.POSBillId =" + billId.ToString + ""
                ...
                While dr1.Read()
                    ...
                    lineQuantity = lineQuantity + cal_qty

                    cal_tax = dr1.GetValue(3)
                    TaxAmt = TaxAmt + cal_tax

                    cal_dis = dr1.GetValue(4)
                    discountVal = discountVal + cal_dis

                    cal_linetotal = dr1.GetValue(5)
                    lineTotal = lineTotal + cal_linetotal

                    cal_gross = dr1.GetValue(7)
