...
Module Module1
    ...
    Sub Main()
        ...
        Try
            ...
            cn.Open()
            ' Dim querystr As String = "select RIH_SR_CD,RIH_INVNO ,RIH_INVDTE   ,(RIH_BILLDISCPER + RIH_DISCAMT) as disc ,RIH_TOTALQTY ,RIH_BILLAMT ,RIH_TAXAMT,RIH_VOIDFLAG,RIH_PAYMENT_MODE  from dbo.RETAIL_INVOICEHEADER where RIH_LOYALTYPOINT is not null and RIH_INVDTE > '" + sale_date + "' order by RIH_INVDTE"
