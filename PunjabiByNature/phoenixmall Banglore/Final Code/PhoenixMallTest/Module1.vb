...
Module Module1
    ...
    Sub Main()
        ...
        Try
            ...
            Dim querystr As String = "select billno,billdtm,(amount-(disamt+taxamt)) as gross_amt,round(amount,2) as invoice_amt,taxamt,disamt,paymode from qbillhea_PM  where billno > '" + response1 + "' order by billno "
            ...
            While dr.Read()
                ...
                Dim grossValue As Decimal = Convert.ToDecimal(dr.GetValue(2))
                ...
                Dim query_1 As String = "select itcode,qty,tax,((qty*brate)+tax) as linetotal, rate as unit_price from qbilldet_PM where  billno ='" + receiptNo + "'"
                ...
                While dr1.Read()
                    ...
                    Dim lineTotal As Decimal = Convert.ToDecimal(dr1.GetValue(3))
                ...
                sales_record = receiptNo + SEPARATOR_FIELDS + docDt + SEPARATOR_FIELDS + docTime + SEPARATOR_FIELDS + grossValue.ToString() + SEPARATOR_FIELDS + totNetDocValue.ToString() + SEPARATOR_FIELDS + tax.ToString() + SEPARATOR_FIELDS + totDisc.ToString() + SEPARATOR_FIELDS + saleQtySum.ToString() + SEPARATOR_FIELDS + transaction_id + SEPARATOR_FIELDS + " " + SEPARATOR_FIELDS + pmode + SEPARATOR_FIELDS + "1" + SEPARATOR_FIELDS
