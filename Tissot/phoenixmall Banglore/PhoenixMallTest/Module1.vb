...
Module Module1
    ...
    Sub Main()
        ...
        Try
            ...
            Dim querystr As String = "select ReceiptNo,billDateTime,InvoiceAmount,TotTAX,TotDiscount,NetAmount,Amount,Qty from HDbilldetails where ReceiptNo like '%BLT%' AND billDateTime >= '" + response1 + "' order by billDateTime"
            ...
            While dr.Read()
                ...
                Dim transaction_id As String = dr.GetDateTime(1).ToString("yyyy-MM-dd 00:00:00")
