...
Module Module1
    ...
    Sub Main()
        ...
        Try
            ...
            Dim querystr As String = "select DocNoPrefix,DocNo,DocTime,TotDocValue as gross_amt,NetDocValue as total_amount,TotDocTax ,TotDocDisc,TotalLineItems,TrnType as flag,DocDt   from StkTrnHdr where DocTime > '" + response + "'  and (DocNoPrefix like 'S15S%' or DocNoPrefix like 'S15R%') order by DocTime "
