...
Module Module1
    ...
    Sub Main()
        ...
        Try
            ...
            Dim querystr As String = "select RECEIPTID,CREATEDDATETIME,PAYMENTAMOUNT,DISCAMOUNT,TRANSDATE from ax.RETAILTRANSACTIONTABLE where CREATEDDATETIME>'" + salres + "' and (RECEIPTID like 'A000601%') and STORE='SKABLA0006' order by CREATEDDATETIME "
            ...
            While dr.Read()
                ...
                Dim docDt As String = Convert.ToString(dr.GetValue(4))
                ...
                Dim query_1 As String = "select ITEMID,TAXAMOUNT,QTY,DISCAMOUNT,PRICE,NETAMOUNTINCLTAX*-1 from ax.RETAILTRANSACTIONSALESTRANS where (RECEIPTID like 'A000601%') and store='SKABLA0006' and TRANSACTIONSTATUS=0 and RECEIPTID='" + receiptNo + "'"
