...
Module Module1
    ...
    Sub Main()
        ...
        Try
            ...
            cn.Open()
            Dim querystr As String = "select Id,InvNumber,Date,GrandTotal as invoice_tot,TaxGrandTotal as tax,ItemTotal as gross,TotalItemQty,DiscountTotal,SalesType  from dbo.tbl_DYN_SalesInvoices where date>'" + response + "' and InvNumber like 'unn%' order by Date"
