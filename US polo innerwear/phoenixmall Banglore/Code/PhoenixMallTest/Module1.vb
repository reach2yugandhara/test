...
Module Module1
    ...
    Sub Main()
        ...
        Try
            ...
            cn = New OleDbConnection(connectString)
            cn.Open()
            Dim querystr As String = "SELECT s.DocNoPrefix,s.DocNo,s.DocDt,s.TotDocValue,s.TotDocTax,s.NetDocValue,s.TotDocDisc,s.TotalLineItems,s.TrnType,s.TrnCtrlNo, s.DocVoidInd,s.FrwdRefCtrlNo,FrwdRefTrnType FROM StkTrnHdr s where s.TrnCtrlNo > " + returnLastNo.ToString() + " and DocNoPrefix like 'R%'"
    ...
    Private Function serverUpload(ByVal subUrl As String, ByVal params As NameValueCollection)
        ...
        Dim url As String = serverProtocol + "://192.168.0.29/phoenix_new/public_html/" + serverPath + "/" + subUrl
