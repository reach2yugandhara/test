...
Module Module1
    ...
    Sub Main()
        ...
        Try
            ...
            Dim querystr As String = "select id,BillNo,BillDate,GrossAmt,NetPayable,DiscountAmt from dbo.POSBill where BillDate > '" + response + "' order by BillDate"
            ...
            While dr.Read()
                ...
                Dim query_1 As String = "select a.ItemId,(select b.Name from dbo.Item b where a.ItemId=b.ItemId), Qty,TaxAmt,DiscountAmt,NetAmt,MRP  from dbo.POSBillItem a where a.POSBillId =" + billId.ToString + ""
